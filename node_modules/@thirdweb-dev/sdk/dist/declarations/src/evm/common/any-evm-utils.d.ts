...
import { DeploymentInfo, KeylessDeploymentInfo, KeylessTransaction } from "../types/any-evm/deploy-data";
 ...
 * @param create2FactoryAddress
 */
export declare function deployContractDeterministic(signer: Signer, bytecode: string, encodedArgs: BytesLike, create2FactoryAddress: string, options?: DeployOptions, predictedAddress?: string, gasLimit?: number): Promise<void>;
/**
 *
 ...
 * @param create2Factory
 */
export declare function getDeploymentInfo(metadataUri: string, storage: ThirdwebStorage, provider: providers.Provider, create2Factory?: string): Promise<DeploymentInfo>;
/**
 ...
 */
export declare function deployInfraWithSigner(signer: Signer, provider: providers.Provider, storage: ThirdwebStorage, create2Factory: string, contractTypes: InfraContractType[], options?: DeployOptions): Promise<void>;
/**
 *
 * @public
 * @param transaction: Unsigned transaction object
 * @param signature: Signature bytes
 */
export declare function getCreate2FactoryDeploymentInfo(chainId: number): KeylessDeploymentInfo;
export declare function computeAddressInfra(contractType: InfraContractType, provider: providers.Provider, storage: ThirdwebStorage, create2Factory: string): Promise<string>;
