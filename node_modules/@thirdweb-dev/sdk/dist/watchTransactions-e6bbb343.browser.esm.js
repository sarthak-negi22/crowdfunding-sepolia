...
const CloneFactory = {
  name: "TWCloneFactory",
  contractType: "cloneFactory"
};
const NativeTokenWrapper = {
  name: "WETH9",
  contractType: "nativeTokenWrapper"
};
const Forwarder = {
  name: "Forwarder",
...
const EOAForwarder = {
  ...
  contractType: "eoaForwarder"
};

/**
 * @internal
 */
const INFRA_CONTRACTS_MAP = {
...
const EditionDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([await EditionDropInitializer.getAbi(address, provider, storage), import('./edition-drop-7ff5c811.browser.esm.js'), provider.getNetwork()]);
...
const EditionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider, storage), import('./edition-76e584a3.browser.esm.js'), provider.getNetwork()]);
...
const MarketplaceInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider, storage), import('./marketplace-d5bf397a.browser.esm.js'), provider.getNetwork()]);
...
const MarketplaceV3Initializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceV3Initializer.getAbi(address, provider, storage), import('./marketplacev3-d4d1a147.browser.esm.js'), provider.getNetwork()]);
...
const MultiwrapInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider, storage), import('./multiwrap-bf649911.browser.esm.js'), provider.getNetwork()]);
...
const NFTCollectionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider, storage), import('./nft-collection-ed32fd4a.browser.esm.js'), provider.getNetwork()]);
...
const NFTDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider, storage), import('./nft-drop-ae2d85f2.browser.esm.js'), provider.getNetwork()]);
...
const PackInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider, storage), import('./pack-8097a968.browser.esm.js'), provider.getNetwork()]);
...
const SignatureDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider, storage), import('./signature-drop-f02ca842.browser.esm.js'), provider.getNetwork()]);
...
const SplitInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider, storage), import('./split-d4c5c96e.browser.esm.js'), provider.getNetwork()]);
...
const TokenDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider, storage), import('./token-drop-723c3145.browser.esm.js'), provider.getNetwork()]);
...
const TokenInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider, storage), import('./token-f6219b11.browser.esm.js'), provider.getNetwork()]);
...
const VoteInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider, storage), import('./vote-39741880.browser.esm.js'), provider.getNetwork()]);
...
async function isEIP155Enforced(provider) {
  try {
    ...
    if (e.toString().toLowerCase().includes("eip-155") || e.message?.toString().toLowerCase().includes("eip-155") || e.data?.message?.toString().toLowerCase().includes("eip-155")) {
      return true;
    }
    return false;
  }
...
async function computeEOAForwarderAddress(provider, storage, create2Factory) {
  ...
  return await computeAddressInfra(EOAForwarder.contractType, provider, storage, create2Factory);
}
...
async function computeForwarderAddress(provider, storage, create2Factory) {
  ...
  return await computeAddressInfra(Forwarder.contractType, provider, storage, create2Factory);
}
...
async function computeCloneFactoryAddress(provider, storage, create2Factory) {
  ...
  return await computeAddressInfra(CloneFactory.contractType, provider, storage, create2Factory);
}
...
async function computeNativeTokenAddress(provider, storage, create2Factory) {
  ...
  return await computeAddressInfra(NativeTokenWrapper.contractType, provider, storage, create2Factory);
}
...
async function deployCreate2Factory(signer, options) {
  ...
  if (!factoryExists) {
    ...
    if ((await signer.provider.getBalance(deploymentInfo.signer)).lt(toWei("0.01"))) {
 ...
 * @param create2FactoryAddress
 */
async function deployContractDeterministic(signer, bytecode, encodedArgs, create2FactoryAddress, options, predictedAddress) {
  ...
  const code = predictedAddress ? await signer.provider?.getCode(predictedAddress) : "0x";
  if (code === "0x") {
...
async function getDeploymentInfo(metadataUri, storage, provider, create2Factory) {
  ...
  const {
    encodedArgs,
    infraContracts
  } = await encodeConstructorParamsForImplementation(compilerMetadata, provider, storage, create2Factory);

  // 2. Compute the CREATE2 address
  const predictedAddress = computeDeploymentAddress(compilerMetadata.bytecode, encodedArgs, create2Factory);
 ...
 */
async function deployInfraWithSigner(signer, provider, storage, create2Factory, contractTypes, options) {
  const txns = [];
  for (let contractType of contractTypes) {
    const infraContractAddress = await computeAddressInfra(contractType, provider, storage, create2Factory);
    if (contractType === NativeTokenWrapper.contractType) {
      const code = await provider.getCode(infraContractAddress);
      if (code === "0x") {
        const initCode = getInitBytecodeWithSalt(bytecode, []);
        txns.push({
    ...
    const uri = await fetchPublishedContractURI(INFRA_CONTRACTS_MAP[contractType].name);
    const infraContractMetadata = await fetchPreDeployMetadata(uri, storage);
    const code = await provider.getCode(infraContractAddress);
    if (code === "0x") {
      const encodedArgs = (await encodeConstructorParamsForImplementation(infraContractMetadata, provider, storage, create2Factory)).encodedArgs;
      // get init bytecode
      const initBytecodeWithSalt = getInitBytecodeWithSalt(infraContractMetadata.bytecode, encodedArgs);
      txns.push({
        predictedAddress: infraContractAddress,
        to: create2Factory,
        data: initBytecodeWithSalt
  ...
  if (txns.length > 0) {
    txns.forEach(tx => console.debug(`deploying infra contract at: ${tx.predictedAddress}`));
    options?.notifier?.("deploying", "infra");
    // Using the deployer contract, send the deploy transactions to common factory with a signer
    const deployer = new ethers.ContractFactory(DEPLOYER_ABI, DEPLOYER_BYTECODE).connect(signer).deploy(txns);
 ...
 * @param signature: Signature bytes
 */
function getCreate2FactoryDeploymentInfo(chainId) {
...
async function fetchPublishedContractURI(contractName) {
...
async function computeAddressInfra(contractType, provider, storage, create2Factory) {
  ...
  if (contract.contractType === NativeTokenWrapper.contractType) {
    ...
    const encodedArgs = (await encodeConstructorParamsForImplementation(metadata, provider, storage, create2Factory)).encodedArgs;
 ...
 */
async function encodeConstructorParamsForImplementation(compilerMetadata, provider, storage, create2Factory) {
  ...
  const constructorParamValues = await Promise.all(constructorParams.map(async p => {
    if (p.name && p.name.includes("nativeTokenWrapper")) {
      ...
      if (nativeTokenWrapperAddress === ethers.constants.AddressZero) {
        nativeTokenWrapperAddress = await computeNativeTokenAddress(provider, storage, create2Factory);
      ...
      if (compilerMetadata.analytics?.contract_name && compilerMetadata.analytics.contract_name === "Pack") {
        ...
        const eoaForwarderAddress = await computeEOAForwarderAddress(provider, storage, create2Factory);
        return eoaForwarderAddress;
      }
      infraContracts.push(Forwarder.contractType);
      const forwarderAddress = await computeForwarderAddress(provider, storage, create2Factory);
    ...
    _defineProperty(this, "deployContractFromUri", buildDeployTransactionFunction(async (publishMetadataUri, constructorParamValues, options) => {
      ...
      if (extendedMetadata && extendedMetadata.factoryDeploymentData && (extendedMetadata.isDeployableViaProxy || extendedMetadata.isDeployableViaFactory) && !forceDirectDeploy) {
        ...
        if (implementationAddress) {
          ...
          // 3. deploy infra
          await deployInfraWithSigner(signer, this.getProvider(), this.storage, create2Factory, deploymentInfo.infraContractsToDeploy, options);

          // 4. deploy implementation contract
          await deployContractDeterministic(signer, deploymentInfo.bytecode, deploymentInfo.encodedArgs, create2Factory, options, deploymentInfo.predictedAddress);
          const resolvedImplementationAddress = await resolveAddress(implementationAddress);
  ...
  async getTransactionsForDeploy(publishMetadataUri, options) {
    ...
    if (extendedMetadata && extendedMetadata.factoryDeploymentData && (extendedMetadata.isDeployableViaProxy || extendedMetadata.isDeployableViaFactory) && !forceDirectDeploy) {
      ...
      if (!implementationAddress) {
        ...
        const infraAddresses = await Promise.all(deploymentInfo.infraContractsToDeploy.map(contract => {
          return computeAddressInfra(contract, this.getProvider(), this.storage, create2FactoryAddress);
        }));
        transactions.push({
          contractType: "infra",
